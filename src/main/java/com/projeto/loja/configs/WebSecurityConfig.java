...
import com.projeto.loja.services.AuthService;
import com.projeto.loja.services.TokenService;
import com.projeto.loja.tools.AuthTokenFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.userDetailsService(AuthS).passwordEncoder(new BCryptPasswordEncoder());
    }
    @Override
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .antMatchers(HttpMethod.GET,"/endereco/*").permitAll()
        .antMatchers(HttpMethod.DELETE,"/endereco/*").permitAll()
        ...
        .and()
        .addFilterBefore(new AuthTokenFilter(TokenS), UsernamePasswordAuthenticationFilter.class);
    }
    @Override
